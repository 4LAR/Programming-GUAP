...
QT_MOC_LITERAL(1, 7, 15), // "notifyObservers"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "states\0notifyObservers\0"
};
...
void states::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<states *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->notifyObservers(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (states::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&states::notifyObservers)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject states::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_states.data,
    qt_meta_data_states,
    qt_static_metacall,
    nullptr,
    nullptr
